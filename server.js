...
app.post("/api/fms", async (req, res) => {
  const scriptUrl = "https://script.google.com/macros/s/AKfycbwdJoWH_3DEyEiTDf2MfmRYpOumu7w20N2vL0ch7mw_gS0-GBej0B4ApSQ4t0PObcEP/exec";
  ...
  try {
    ...
    console.log("🔥 Incoming request to /api/fms:", req.body.action);
